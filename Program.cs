...
namespace EMS1
{
    internal class Program
    {
                ...
                if (i == "ADMIN")
                {
                    while (true)
                    {
                        ...
                        if (j == "1") // STARTING MOST NESTED IF
                        {
                            ...
                            addUser(ref user, ref pass, ref role , ref ind);
        ...
        static void addUser(ref string user, ref string pass, ref string role , ref string ipass) // adding user
        {
            Login temp = new Login();
            Employ temp1 = new Employ();
                if(ipass == " ")
                {
                     ipass = pass;
                }
                ...
                {
                    temp1.emp_nameA = user;
                    temp.initialPassA = ipass;
        ...
        static void storeArray() // to store data from file t array
        {
            ...
            while ((line = fp.ReadLine()) != null)
            {
                ...
                if (rol == "EMPLOY")
                {
                    ...
                    employList1.emp_nameA = us;
                    employList1.emp_payA = emp_pay;
                    employList1.emp_rankA = rnk;
                    employList1.emp_rewardA = emp_reward;
                    employList1.emp_attendanceA = emp_attendance;
                    employList1.emp_absenceA = emp_absence;
                    employList1.emp_deductA = emp_deduct;
                    employList1.task1_timeA = task1_time;
                    employList1.task2_timeA = task2_time;
                    employList1.task3_timeA = task3_time;
                    employList1.task4_timeA = task4_time;
                    employList1.emp_comp_taskA = emp_comp_task;
                    ...
                    employList1.payA = payannounce;
                    employList.Add(employList1 );
                    ipass = getParse(line, 19);
                }
                addUser(ref us, ref pass, ref rol , ref ipass);
            }
            fp.Close();
        }
